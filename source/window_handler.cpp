...
WindowHandler::WindowHandler(Glib::RefPtr<Builder> builder)
  ...
  connectEvent(drawingarea_main, drawingarea_main->signal_button_press_event(),
  ...
  connectEvent(drawingarea_main, drawingarea_main->signal_motion_notify_event(),
               &WindowHandler::on_drawing_area_motion_notify);
  connectEvent(drawingarea_main, drawingarea_main->signal_enter_notify_event(),
               &WindowHandler::on_drawing_area_enter_notify);
  connectEvent(drawingarea_main, drawingarea_main->signal_leave_notify_event(),
  ...
  // List Store
  liststore_projects =
      Glib::RefPtr<ListStore>::cast_static(treeview_projects_open->get_model());
  ...
  shift_center_changed_con = connectEvent(
      switch_shift_center, switch_shift_center->signal_state_changed(),
      &WindowHandler::on_shift_center_changed);

  builder->get_widget("switch_enable_absorb", switch_enable_absorb);
  enable_absorb_changed_con = connectEvent(
      switch_enable_absorb, switch_enable_absorb->signal_state_changed(),
      &WindowHandler::on_enable_absorb_changed);

  builder->get_widget("switch_osc_enabled", switch_osc_enabled);
  osc_enabled_changed_con = connectEvent(
      switch_osc_enabled, switch_osc_enabled->signal_state_changed(),
  ...
  connectEvent(switch_extreme_cont, switch_extreme_cont->signal_state_changed(),
  ...
  builder->get_widget("switch_ignore_scale_scroll", switch_ignore_scale_scroll);

  // Radio Button
  builder->get_widget("radiobutton_point", radiobutton_point);
  on_source_changed_con[0] =
      connectEvent(radiobutton_point, radiobutton_point->signal_toggled(),
                   &WindowHandler::on_source_changed);

  builder->get_widget("radiobutton_line", radiobutton_line);
  on_source_changed_con[1] =
      connectEvent(radiobutton_line, radiobutton_line->signal_toggled(),
                   &WindowHandler::on_source_changed);

  builder->get_widget("radiobutton_moving_point", radiobutton_moving_point);
  on_source_changed_con[2] = connectEvent(
      radiobutton_moving_point, radiobutton_moving_point->signal_toggled(),
      &WindowHandler::on_source_changed);
  ...
  size_changed_con =
      connectEvent(spinbutton_size, spinbutton_size->signal_value_changed(),
  ...
  connectEvent(spinbutton_loss, spinbutton_loss->signal_scroll_event(),
               &WindowHandler::on_scroll);
  loss_changed_con =
      connectEvent(spinbutton_loss, spinbutton_loss->signal_value_changed(),
                   &WindowHandler::on_loss_changed);

  builder->get_widget("spinbutton_abs_peak", spinbutton_abs_peak);
  connectEvent(spinbutton_abs_peak, spinbutton_abs_peak->signal_scroll_event(),
               &WindowHandler::on_scroll);
  abs_peak_changed_con = connectEvent(
      spinbutton_abs_peak, spinbutton_abs_peak->signal_value_changed(),
  ...
  connectEvent(spinbutton_abs_thick,
               ...
               &WindowHandler::on_scroll);
  abs_thick_changed_con = connectEvent(
      spinbutton_abs_thick, spinbutton_abs_thick->signal_value_changed(),
  ...
  connectEvent(spinbutton_period, spinbutton_period->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_period_changed_con =
      connectEvent(spinbutton_period, spinbutton_period->signal_value_changed(),
  ...
  connectEvent(spinbutton_phase, spinbutton_phase->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_phase_changed_con =
      connectEvent(spinbutton_phase, spinbutton_phase->signal_value_changed(),
  ...
  connectEvent(spinbutton_amp, spinbutton_amp->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_amp_changed_con =
      connectEvent(spinbutton_amp, spinbutton_amp->signal_value_changed(),
  ...
  connectEvent(spinbutton_locx1, spinbutton_locx1->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_locx1_changed_con =
      connectEvent(spinbutton_locx1, spinbutton_locx1->signal_value_changed(),
  ...
  connectEvent(spinbutton_locy1, spinbutton_locy1->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_locy1_changed_con =
      connectEvent(spinbutton_locy1, spinbutton_locy1->signal_value_changed(),
  ...
  connectEvent(spinbutton_locx2, spinbutton_locx2->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_locx2_changed_con =
      connectEvent(spinbutton_locx2, spinbutton_locx2->signal_value_changed(),
  ...
  connectEvent(spinbutton_locy2, spinbutton_locy2->signal_scroll_event(),
               &WindowHandler::on_scroll);
  on_locy2_changed_con =
      connectEvent(spinbutton_locy2, spinbutton_locy2->signal_value_changed(),
  ...
  connectEvent(spinbutton_move_period,
               ...
               &WindowHandler::on_scroll);
  on_move_period_changed_con = connectEvent(
      spinbutton_move_period, spinbutton_move_period->signal_value_changed(),
      &WindowHandler::on_move_period_changed);

  builder->get_widget("spinbutton_mass_pen", spinbutton_mass_pen);
  connectEvent(spinbutton_mass_pen, spinbutton_mass_pen->signal_scroll_event(),
               &WindowHandler::on_scroll);
  connectEvent(spinbutton_mass_pen, spinbutton_mass_pen->signal_value_changed(),
  ...
  connectEvent(spinbutton_mass_min, spinbutton_mass_min->signal_scroll_event(),
               &WindowHandler::on_scroll);
  connectEvent(spinbutton_mass_min, spinbutton_mass_min->signal_value_changed(),
               &WindowHandler::on_mass_min_changed);

  builder->get_widget("spinbutton_mass_max", spinbutton_mass_max);
  connectEvent(spinbutton_mass_max, spinbutton_mass_max->signal_scroll_event(),
               &WindowHandler::on_scroll);
  connectEvent(spinbutton_mass_max, spinbutton_mass_max->signal_value_changed(),
  ...
  if (projectHandler.setProjectsPath(projectHandler.getProjectsPath(), true) ==
    ...
    if (projectHandler.openProject("default", description, &waveEngine) != OK) {
      std::cout << "Couldn't find the default scene. Creating one."
                << std::endl;
      if (projectHandler.saveProject(
              "default", textview_description->get_buffer()->get_text(false),
              &waveEngine) != OK) {
  ...
  if (m_image) {
    dispatcher.connect(sigc::mem_fun(
        *this, &WindowHandler::on_notification_from_render_thread));
  }
  ...
  switch_show_oscs->set_active(inireader.GetBoolean(
      "pool_oscillators", "show_oscillators", switch_show_oscs->get_active()));

  scale_font_size->set_value(inireader.GetReal("pool_oscillators", "font_size",
                                               scale_font_size->get_value()));

  spinbutton_mass_pen->set_value(inireader.GetInteger(
      "pool_mass", "pen_thickness", spinbutton_mass_pen->get_value()));

  switch_mass_line_mode->set_active(inireader.GetBoolean(
      "pool_mass", "line_mode", switch_mass_line_mode->get_active()));

  spinbutton_primary_mass->set_value(inireader.GetReal(
      "pool_mass", "primary_mass", spinbutton_primary_mass->get_value()));

  spinbutton_secondary_mass->set_value(inireader.GetReal(
      "pool_mass", "secondary_mass", spinbutton_secondary_mass->get_value()));

  spinbutton_mass_min->set_value(inireader.GetReal(
      "pool_mass", "mass_range_minimum", waveEngine.getMassMapRangeLow()));

  spinbutton_mass_max->set_value(inireader.GetReal(
      "pool_mass", "mass_range_maximum", waveEngine.getMassMapRangeHigh()));

  spinbutton_static_pen->set_value(inireader.GetInteger(
      "pool_static", "pen_thickness", spinbutton_static_pen->get_value()));

  switch_static_line_mode->set_active(inireader.GetBoolean(
      "pool_static", "line_mode", switch_static_line_mode->get_active()));

  spinbutton_max_iterate->set_value(
      inireader.GetReal("threading", "iterations_per_second",
                        waveEngine.getIterationsPerSecond()));

  spinbutton_num_co->set_value(inireader.GetInteger(
      "threading", "number_of_co_threads", waveEngine.getNumberOfThreads()));

  spinbutton_thread_sleep->set_value(inireader.GetInteger(
      "threading", "thread_sleep_duration", waveEngine.getThreadDelay()));

  switch_render->set_active(inireader.GetBoolean(
      "rendering", "render", waveEngine.getRenderEnabled()));

  spinbutton_max_fps->set_value(inireader.GetReal(
      "rendering", "frames_per_second", waveEngine.getFramesPerSecond()));
  ...
  switch_extreme_cont->set_active(inireader.GetBoolean(
      "rendering", "extreme_contrast", waveEngine.getExtremeContrastEnabled()));
  ...
  on_crest_changed(colorbutton_crest); // Setting the color won't trigger the
                                       // event on its own.
  ...
  on_trough_changed(colorbutton_trough); // Setting the color won't trigger the
                                         // event on its own.
  ...
  on_static_color_changed(colorbutton_static); // Setting the color won't
                                               // trigger the event on its own.

  switch_ignore_num_scroll->set_active(inireader.GetBoolean(
      "ui", "ignore_numeric_scroll", switch_ignore_num_scroll->get_active()));

  switch_ignore_list_scroll->set_active(inireader.GetBoolean(
      "ui", "ignore_list_scroll", switch_ignore_list_scroll->get_active()));

  switch_ignore_scale_scroll->set_active(inireader.GetBoolean(
      "ui", "ignore_scale_scroll", switch_ignore_scale_scroll->get_active()));

  spinbutton_dec_place->set_value(inireader.GetInteger(
      "ui", "decimal_places", spinbutton_dec_place->get_value()));
    ...
    if (arg->type != GDK_DOUBLE_BUTTON_PRESS) {
      ...
      case 1:
        ...
        if (edit_mass || edit_static) {
          ...
          oscillator_helper(drawingArea->get_width(), drawingArea->get_height(),
                            arg->x, arg->y);
        }
        break;
      case 2:
...
bool WindowHandler::on_main_window_key_press(GdkEventKey *arg, Window *window) {
  ...
  if (!(arg->state & GDK_CONTROL_MASK)) {
    ...
    if (focused == nullptr || (typeid(*focused) != typeid(SpinButton) &&
      ...
      case GDK_KEY_s:
      case GDK_KEY_S:
        switch_edit_static->set_active(!switch_edit_static->get_active());
        break;
      case GDK_KEY_m:
      case GDK_KEY_M:
...
bool WindowHandler::on_drawing_area_scroll(GdkEventScroll *arg,
  ...
  if (edit_static) {
    ...
    if (arg->direction == GDK_SCROLL_DOWN)
      incdec *= -1;
    spinbutton_static_pen->set_value(spinbutton_static_pen->get_value() +
                                     incdec);
  } else if (edit_mass) {
    double incdec = spinbutton_mass_pen->get_adjustment()->get_step_increment();
    if (arg->direction == GDK_SCROLL_DOWN)
      incdec *= -1;
    spinbutton_mass_pen->set_value(spinbutton_mass_pen->get_value() + incdec);
  } else {
    int rowid = comboboxtext_sel_osc->get_active_row_number();
    double incdec = spinbutton_period->get_adjustment()->get_step_increment();
    if (arg->direction == GDK_SCROLL_DOWN)
      incdec *= -1;
    waveEngine.setOscillatorPeriod(
        rowid, waveEngine.getOscillatorPeriod(rowid) + incdec);
    updateSelectedOsc();
  }
...
bool WindowHandler::on_scroll(GdkEventScroll *arg, Widget *widget) {
  ...
  if ((spinButton != nullptr && switch_ignore_num_scroll->get_active()) ||
      (comboBoxText != nullptr && switch_ignore_list_scroll->get_active()) ||
...
void WindowHandler::on_osc_enabled_changed(StateType state, Switch *_switch) {
  waveEngine.setOscillatorEnabled(comboboxtext_sel_osc->get_active_row_number(),
                                  _switch->get_active());
}

void WindowHandler::on_period_changed(SpinButton *spinButton) {
  waveEngine.setOscillatorPeriod(comboboxtext_sel_osc->get_active_row_number(),
...
void WindowHandler::on_amp_changed(SpinButton *spinButton) {
  waveEngine.setOscillatorAmplitude(
      comboboxtext_sel_osc->get_active_row_number(), spinButton->get_value());
}
...
void WindowHandler::on_activate(Widget *widget) {
  ...
  if (imageMenuItem != nullptr) {
    if (imageMenuItem == imagemenuitem_quit)
      ...
      // helpWindow->show();
      if (showMsg("The following command is going to be executed to view PDF "
                  "file:\n\n" +
                      cmd +
                      "\n\nSupposedly, a third-party program will open the "
                      "file. Proceed?",
                  MessageType::MESSAGE_QUESTION, ButtonsType::BUTTONS_YES_NO,
                  mainWindow) == GTK_RESPONSE_YES) {
        int ret = system(cmd.c_str());
        std::cout << "system() is called for opening the help file. Returned "
                  << ret << std::endl;
      }
...
void WindowHandler::on_open_clicked(ToolButton *toolButton) {
  ...
  while (openProjectDialog->run() == GTK_RESPONSE_OK) {
    ...
    if (selected != nullptr) {
      ...
      string description;
      ProjectHandlerResult result =
          projectHandler.openProject(name, description, &waveEngine);
      if (result == OK) {
        textview_description->get_buffer()->set_text(description);
        lastProjectName = name;
        mainWindow->set_title(ustring("Wave Simulator - ") + lastProjectName);
        unsigned int size = waveEngine.getSize();
        m_image =
            Gdk::Pixbuf::create(Gdk::COLORSPACE_RGB, false, 8, size, size);
        updateSelectedOsc();
        updatePoolGeneral();
        ...
        showMsg("Error occurred while opening the project.", MESSAGE_ERROR,
...
void WindowHandler::on_save_clicked(ToolButton *toolButton) {
  ...
  while (saveProjectDialog->run() == GTK_RESPONSE_OK) {
    ...
    if (name.length() > 0) {
      if (name != "default" ||
          (name == "default" &&
           showMsg("You are about to overwrite the default scene which"
                   " is loaded every time the program starts. Save anyways?",
                   MESSAGE_QUESTION, BUTTONS_YES_NO,
                   saveProjectDialog) == GTK_RESPONSE_YES)) {

        ProjectHandlerResult result = projectHandler.saveProject(
            name, textview_description->get_buffer()->get_text(false),
            &waveEngine);
        if (result == OK) {
          lastProjectName = name;
          mainWindow->set_title(ustring("Wave Simulator - ") + lastProjectName);
          ...
          showMsg("Error occurred while saving the project.", MESSAGE_ERROR,
                  BUTTONS_OK, saveProjectDialog);
        }
      }
    } else {
      showMsg(
...
void WindowHandler::on_new_clicked(ToolButton *toolButton) {
  string description;
  ProjectHandlerResult result =
      projectHandler.openProject("default", description, &waveEngine);
  if (result == OK) {
    textview_description->get_buffer()->set_text(description);
    lastProjectName = "default";
    ...
    showMsg("Error occurred while opening the default scene.", MESSAGE_ERROR,
...
void WindowHandler::on_source_changed(RadioButton *radioButton) {
  ...
  if (radio_active) {
    ...
    if (radioButton == radiobutton_point)
      ...
      waveEngine.setOscillatorSource(
          comboboxtext_sel_osc->get_active_row_number(), MovingPointSource);
  }
}
...
void WindowHandler::refresh_scene() {
  ...
  if (waveEngine.lock()) {
    double *pdv = (double *)waveEngine.getData(ParticleAttribute::Velocity);
...
void WindowHandler::oscillator_helper(int width, int height, double x,
  ...
  waveEngine.setOscillatorLocation(
      comboboxtext_sel_osc->get_active_row_number(), pressing_left_mb ? 0 : 1,
      Point(xratio * size, yratio * size));
  updateSelectedOsc();
}
void WindowHandler::draw_helper(int width, int height, double x, double y) {
  ...
  if (waveEngine.lock()) {
    if (edit_static)
      drawThickLine(
          (bool *)waveEngine.getData(Fixity),
          pressing_right_mb ^
              (comboboxtext_static_op->get_active_row_number() == 0 ? true
                                                                    : false),
          size, m_loc_old, m_loc, spinbutton_static_pen->get_value() / 2);
    else if (edit_mass)
      drawThickLine((double *)waveEngine.getData(ParticleAttribute::Mass),
                    pressing_left_mb ? spinbutton_primary_mass->get_value()
                                     : spinbutton_secondary_mass->get_value(),
                    size, m_loc_old, m_loc,
                    spinbutton_mass_pen->get_value() / 2);
    waveEngine.unlock();
  }
}
...
void WindowHandler::iterateShape(array a, value v, Point p1, Point p2, int x,
                                 int y, double radius, int size) {
...
void WindowHandler::drawLine(array arr, value val, unsigned int size, Point p1,
  ...
  for (double i = 0; i < length; i += 0.5) {
    ...
    if (currentPoint.x < size && currentPoint.x >= 0 && currentPoint.y < size &&
        currentPoint.y >= 0)
...
void WindowHandler::updateSelectedOsc() {
  ...
  Point p1 = waveEngine.getOscillatorLocation(rowId, 0),
        p2 = waveEngine.getOscillatorLocation(rowId, 1);
  ...
  spinbutton_move_period->set_value(waveEngine.getOscillatorMovePeriod(rowId));
...
void WindowHandler::updateCursor(bool arrow) {
  bool edit =
      switch_edit_mass->get_active() || switch_edit_static->get_active();
  if (!edit) {
...
void WindowHandler::scanProjects(TreeView *treeView, Dialog *transient) {
  ...
  if (projectHandler.getProjectsList(projects) == OK) {
    ...
    showMsg("Error occurred while scanning the project folder.", MESSAGE_ERROR,
...
void WindowHandler::deleteProject(TreeView *treeView, Dialog *transient) {
  ...
  if (selected != nullptr) {
    ...
    ustring msg;
    if (name == "default")
      msg = "Delete the default scene if only it is in a bad condition."
            " Are you sure you want to delete it? This can't be undone!";
    else
      msg = "Are you sure you want to delete '" + name +
            "'? This can't be undone!";
    if (showMsg(msg, MessageType::MESSAGE_QUESTION, ButtonsType::BUTTONS_YES_NO,
                transient) == GTK_RESPONSE_YES) {
      if (projectHandler.deleteProject(name) != OK)
        showMsg("'" + name + "' could not be deleted.",
                MessageType::MESSAGE_ERROR, ButtonsType::BUTTONS_OK, transient);
      else {
        scanProjects(treeView, transient);
      }
    }
  } else
    showMsg("Please select a project from the list.", MESSAGE_ERROR, BUTTONS_OK,
            transient);
}
...
void WindowHandler::updateInfoLabel() {
  if (pointer_in_drawing_area) {
    ...
    if (locx >= 0 && locx < sz && locy >= 0 && locy < sz) {
      ...
      mass = ((double_t *)waveEngine.getData(ParticleAttribute::Mass))[index];
      static_particle =
          ((uint8_t *)waveEngine.getData(ParticleAttribute::Fixity))[index];
      loss = ((double_t *)waveEngine.getData(ParticleAttribute::Loss))[index];
      height =
          ((double_t *)waveEngine.getData(ParticleAttribute::Height))[index];
      // waveEngine.unlock();
      sprintf(info,
              "x = %d\ty = %d\tmass = %f\tloss = %f\theight = %f\tstatic = %d",
              (int)locx, (int)locy, mass, loss, height, static_particle);
...
void WindowHandler::renderCallback(uint8_t *bitmap_data,
  ...
  if (windowHandler->m_image && !windowHandler->destroying) {
    ...
    unsigned int widthbyte = height * windowHandler->m_image->get_n_channels() *
    ...
    for (unsigned int i = 0; i < height; i++) {
      memcpy(address + rowsize * i, bitmap_data + widthbyte * i, widthbyte);
    }
...
bool WindowHandler::on_draw(const Cairo::RefPtr<Cairo::Context> &cr) {
  ...
  if ((draw_preview || pressing_left_mb || pressing_right_mb) &&
    ...
    if ((pressing_left_mb || pressing_right_mb) &&
      ...
      // Line Mode
      cr->save();
      double vector_angle = vectorToAngle(Point(
          mouse_loc.x - mouse_press_loc.x, mouse_loc.y - mouse_press_loc.y));
      cr->arc(mouse_press_loc.x, mouse_press_loc.y, radius,
              M_PI / 2 - vector_angle, 3 * M_PI / 2 - vector_angle);
      cr->arc(mouse_loc.x, mouse_loc.y, radius, 3 * M_PI / 2 - vector_angle,
              M_PI / 2 - vector_angle);
      cr->close_path();
  ...
  if (switch_show_oscs->get_active()) {
    ...
    for (int i = 0; i < MAX_NUMBER_OF_OSCILLATORS; i++) {
      if (waveEngine.getOscillatorEnabled(i)) {
        ...
        Point osc_display_loc =
            Point(osc_loc.x * scalecommon, osc_loc.y * scalecommon);
        cr->set_source_rgb(1, 1, 1);
...
WindowHandler::~WindowHandler() { destroying = true; }
